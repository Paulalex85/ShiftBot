...
namespace Bot_Staffo
{
    class Gestion_Interval_User
    {
        ...
        public List<Time_Interval> Epuration_List_Interval(List<Shifts> listShift, List<Time_Interval> list_interval)
        {
        ...
        public List<Shifts> Epuration_List_Shifts(List<Shifts> listShift, List<Time_Interval> list_interval)
        {
